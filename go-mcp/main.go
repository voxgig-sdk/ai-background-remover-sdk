// Command AiBackgroundRemover-mcp is an MCP server exposing the AiBackgroundRemover
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AiBackgroundRemover_list  — list records of an entity
//	AiBackgroundRemover_load  — load a single record of an entity
//
