...
type Args struct {
	Entity string         `json:"entity" jsonschema:"background_removal"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AiBackgroundRemoverSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ai-background-remover_list",
		Description: "List records from AiBackgroundRemover. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ai-background-remover_load",
		Description: "Load a single record from AiBackgroundRemover. " +
...
func runOp(client *sdk.AiBackgroundRemoverSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AiBackgroundRemoverSDK, name string) (sdk.AiBackgroundRemoverEntity, error) {
	switch strings.ToLower(name) {
	case "background_removal":
		return client.BackgroundRemoval(nil), nil
