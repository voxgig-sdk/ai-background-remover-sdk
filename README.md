...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ai-background-remover` | `npm install @voxgig-sdk/ai-background-remover` |
| Python | `voxgig-sdk-ai-background-remover` | `pip install voxgig-sdk-ai-background-remover` |
| PHP | `voxgig-sdk/ai-background-remover` | `composer require voxgig-sdk/ai-background-remover` |
| Golang | `github.com/voxgig-sdk/ai-background-remover-sdk/go` | `go get github.com/voxgig-sdk/ai-background-remover-sdk/go` |
| Ruby | `voxgig-sdk-ai-background-remover` | `gem install voxgig-sdk-ai-background-remover` |
| Lua | `voxgig-sdk-ai-background-remover` | `luarocks install voxgig-sdk-ai-background-remover` |
