...
function runner.env_override(m)
  local live = runner.getenv("AIBACKGROUNDREMOVER_TEST_LIVE")
  local override = runner.getenv("AIBACKGROUNDREMOVER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AIBACKGROUNDREMOVER_TEST_EXPLAIN")
