...
local BackgroundRemovalEntity = {}
BackgroundRemovalEntity.__index = BackgroundRemovalEntity


function BackgroundRemovalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BackgroundRemovalEntity)
  self._name = "background_removal"
  self._client = client
...
function BackgroundRemovalEntity:get_name()
  return self._name
end


function BackgroundRemovalEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BackgroundRemovalEntity.new(self._client, opts)
end
...
function BackgroundRemovalEntity:mark_deleted()
  self._deleted = true
end


function BackgroundRemovalEntity:deleted()
  return true == self._deleted
end


function BackgroundRemovalEntity:data_set(args)
  if args ~= nil then
...
function BackgroundRemovalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BackgroundRemovalEntity:match_set(args)
  if args ~= nil then
...
function BackgroundRemovalEntity:match_get()
...
function BackgroundRemovalEntity:stream(action, args, callopts)
...
---@param reqdata BackgroundRemovalCreateData
---@param ctrl? table
---@return BackgroundRemoval
---@return string? err
function BackgroundRemovalEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BackgroundRemovalEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BackgroundRemovalEntity
