...
from aibackgroundremover_sdk.core.helpers import get_ctx_prop, to_map
...
class AiBackgroundRemoverContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AiBackgroundRemoverControl()
        ...
        if isinstance(sp, AiBackgroundRemoverSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AiBackgroundRemoverResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AiBackgroundRemoverResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AiBackgroundRemoverOperation({})
    ...
    def make_error(self, code, msg):
        return AiBackgroundRemoverError(code, msg, self)
