...
from aibackgroundremover_sdk.aibackgroundremover_types import (
    BackgroundRemoval,
...
class BackgroundRemovalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BackgroundRemovalEntity(self._client, opts)
    ...
    def data_get(self) -> BackgroundRemoval:
    ...
    def match_get(self) -> BackgroundRemoval:
    ...
    def create(self, reqdata: BackgroundRemovalCreateData, ctrl=None) -> BackgroundRemoval:
        utility = self._utility
