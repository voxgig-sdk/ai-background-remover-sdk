...
from aibackgroundremover_sdk.utility import register

# Load features
from aibackgroundremover_sdk.feature.base_feature import AiBackgroundRemoverBaseFeature
from aibackgroundremover_sdk.features import _has_feature, _make_feature
...
class AiBackgroundRemoverSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AiBackgroundRemoverUtility()
        self._utility = utility

        from aibackgroundremover_sdk.config import shared_config
    ...
    def get_utility(self):
        return AiBackgroundRemoverUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AiBackgroundRemoverSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def BackgroundRemoval(self, data=None) -> "BackgroundRemovalEntity":
        ...
        from aibackgroundremover_sdk.entity.background_removal_entity import BackgroundRemovalEntity
