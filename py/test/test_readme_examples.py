# AiBackgroundRemover SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AiBackgroundRemoverSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AiBackgroundRemoverSDK(...) and AiBackgroundRemoverSDK.test(...) become
#      AiBackgroundRemoverSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "aibackgroundremover_sdk"
_SDK_CLASS = "AiBackgroundRemoverSDK"
