# AiBackgroundRemover PHP SDK Reference

Complete API reference for the AiBackgroundRemover PHP SDK.
...
#### `AiBackgroundRemoverSDK::test($testopts = null, $sdkopts = null)`
