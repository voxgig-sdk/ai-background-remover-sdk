...
// AiBackgroundRemover SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AiBackgroundRemoverSDK::test)
...
{
    private const SDK_CLASS = 'AiBackgroundRemoverSDK';
    ...
    private const SDK_BASE = 'aibackgroundremover_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../aibackgroundremover_sdk.php';
