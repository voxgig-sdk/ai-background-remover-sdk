...
class AiBackgroundRemoverTestRunner
{
    ...
    {
        $live = self::getenv('AIBACKGROUNDREMOVER_TEST_LIVE');
        $override = self::getenv('AIBACKGROUNDREMOVER_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AIBACKGROUNDREMOVER_TEST_EXPLAIN');
