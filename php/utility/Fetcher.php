...
// AiBackgroundRemover SDK utility: fetcher

class AiBackgroundRemoverFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AiBackgroundRemoverSDK/1.0)';
    ...
    public static function call(AiBackgroundRemoverContext $ctx, string $fullurl, array $fetchdef): array
    {
