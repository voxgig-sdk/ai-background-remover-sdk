...
// AiBackgroundRemover SDK utility: result_basic

class AiBackgroundRemoverResultBasic
{
    public static function call(AiBackgroundRemoverContext $ctx): ?AiBackgroundRemoverResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AiBackgroundRemoverError) ? $result->err->msg : (string)$result->err;
