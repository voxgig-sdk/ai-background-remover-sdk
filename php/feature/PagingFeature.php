...
// AiBackgroundRemover SDK paging feature
...
class AiBackgroundRemoverPagingFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _is_list(AiBackgroundRemoverContext $ctx): bool
    {
