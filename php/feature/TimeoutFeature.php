...
// AiBackgroundRemover SDK timeout feature
...
class AiBackgroundRemoverTimeoutFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _with_timeout(AiBackgroundRemoverContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AiBackgroundRemoverContext $_ctx, float $ms): void
    {
        $client = $this->client;
