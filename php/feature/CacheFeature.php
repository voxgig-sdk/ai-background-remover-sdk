...
// AiBackgroundRemover SDK cache feature
...
class AiBackgroundRemoverCacheFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _through(AiBackgroundRemoverContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
