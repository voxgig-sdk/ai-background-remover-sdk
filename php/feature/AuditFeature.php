...
// AiBackgroundRemover SDK audit feature
...
class AiBackgroundRemoverAuditFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _emit(AiBackgroundRemoverContext $ctx, string $outcome): void
    {
