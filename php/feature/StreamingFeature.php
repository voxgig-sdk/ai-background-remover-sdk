...
// AiBackgroundRemover SDK streaming feature
...
class AiBackgroundRemoverStreamingFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _iterate(AiBackgroundRemoverResult $result): \Generator
    {
    ...
    private function _streamable(AiBackgroundRemoverContext $ctx): bool
    {
