...
// AiBackgroundRemover SDK idempotency feature
...
class AiBackgroundRemoverIdempotencyFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _mutating(AiBackgroundRemoverContext $ctx): bool
    {
