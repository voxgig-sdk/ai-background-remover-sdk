...
// AiBackgroundRemover SDK proxy feature
...
class AiBackgroundRemoverProxyFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    public function init(AiBackgroundRemoverContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AiBackgroundRemoverContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
