...
class AiBackgroundRemoverSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AiBackgroundRemoverHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AiBackgroundRemoverHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AiBackgroundRemoverFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AiBackgroundRemoverFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AiBackgroundRemoverUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AiBackgroundRemoverHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AiBackgroundRemoverHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AiBackgroundRemoverHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AiBackgroundRemoverError($op . "_allow",
                "AiBackgroundRemoverSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AiBackgroundRemoverHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AiBackgroundRemoverError("graphql_error",
                "AiBackgroundRemoverSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function BackgroundRemoval($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_background_removal === null) {
                $this->_background_removal = new BackgroundRemovalEntity($this, null);
            }
            return $this->_background_removal;
        }
        return new BackgroundRemovalEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AiBackgroundRemoverSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
