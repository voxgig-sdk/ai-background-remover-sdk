...
// AiBackgroundRemover SDK utility type

class AiBackgroundRemoverUtility
{
    ...
    public static function copy(AiBackgroundRemoverUtility $src): AiBackgroundRemoverUtility
    {
        $u = new AiBackgroundRemoverUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
