...
|---|---|---|
| `ts/` | @voxgig-sdk/ai-background-remover-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ai-background-remover-sdk \
      --repository voxgig-sdk/ai-background-remover-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ai-background-remover-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ai-background-remover-sdk --id=<id>` removes it.
