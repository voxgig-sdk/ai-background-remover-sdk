...
// AiBackgroundRemover SDK ratelimit feature
...
class AiBackgroundRemoverRatelimitFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _acquire(AiBackgroundRemoverContext $ctx): void
    {
    ...
    private function _track(AiBackgroundRemoverContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
