...
// AiBackgroundRemover SDK rbac feature
...
class AiBackgroundRemoverRbacFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _required(AiBackgroundRemoverContext $ctx): ?string
    {
    ...
    private function _reject(AiBackgroundRemoverContext $ctx, string $required): void
    {
    ...
    private function _track(AiBackgroundRemoverContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
