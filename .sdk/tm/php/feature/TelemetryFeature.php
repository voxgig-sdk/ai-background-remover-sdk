...
// AiBackgroundRemover SDK telemetry feature
...
class AiBackgroundRemoverTelemetryFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _close(AiBackgroundRemoverContext $ctx, bool $ok): void
    {
