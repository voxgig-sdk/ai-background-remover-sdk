...
// AiBackgroundRemover SDK metrics feature
...
class AiBackgroundRemoverMetricsFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _record(AiBackgroundRemoverContext $ctx, bool $ok): void
    {
