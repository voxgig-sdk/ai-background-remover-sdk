...
// AiBackgroundRemover SDK clienttrack feature
...
class AiBackgroundRemoverClienttrackFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    public function PostConstruct(AiBackgroundRemoverContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AiBackgroundRemover-SDK';
