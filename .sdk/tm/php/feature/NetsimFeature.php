...
// AiBackgroundRemover SDK netsim feature
...
class AiBackgroundRemoverNetsimFeature extends AiBackgroundRemoverBaseFeature
{
    ...
    private function _simulate(AiBackgroundRemoverContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AiBackgroundRemoverContext $ctx, array $applied): void
    {
        $client = $this->client;
