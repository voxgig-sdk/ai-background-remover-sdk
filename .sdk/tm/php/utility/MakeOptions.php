...
// AiBackgroundRemover SDK utility: make_options

class AiBackgroundRemoverMakeOptions
{
    ...
    public static function call(AiBackgroundRemoverContext $ctx): array
    {
        ...
        //
        // `AiBackgroundRemoverSchema::optspec()` is built from the model:
        ...
        $optspec = AiBackgroundRemoverSchema::optspec();
