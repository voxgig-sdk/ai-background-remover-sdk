...
// AiBackgroundRemover SDK utility: graphql
//
...
class AiBackgroundRemoverGraphql
{
    ...
    // equivalent.
    public static function body(AiBackgroundRemoverContext $ctx): mixed
    {
    ...
    public static function errors(AiBackgroundRemoverContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
