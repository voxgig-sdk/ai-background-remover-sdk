...
class AiBackgroundRemoverTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AiBackgroundRemoverTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AiBackgroundRemoverTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AiBackgroundRemoverTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
