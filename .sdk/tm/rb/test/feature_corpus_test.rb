# AiBackgroundRemover SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # AiBackgroundRemoverSDK.new, not AiBackgroundRemoverSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    AiBackgroundRemoverSDK.new(opts)
  end
