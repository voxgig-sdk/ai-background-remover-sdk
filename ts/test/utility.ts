...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.AIBACKGROUNDREMOVER_TEST_LIVE ||
    'TRUE' === process.env.AIBACKGROUNDREMOVER_TEST_OVERRIDE
  ) {
  ...
  m.AIBACKGROUNDREMOVER_TEST_EXPLAIN = process.env.AIBACKGROUNDREMOVER_TEST_EXPLAIN || m.AIBACKGROUNDREMOVER_TEST_EXPLAIN
