...
class BackgroundRemovalEntity extends AiBackgroundRemoverEntityBase<BackgroundRemoval> {
  ...
  make(this: BackgroundRemovalEntity) {
  ...
  async create(this: any, reqdata?: BackgroundRemovalCreateData, ctrl?: Control): Promise<BackgroundRemovalEntity> {
