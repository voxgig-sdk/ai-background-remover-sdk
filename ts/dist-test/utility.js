...
function envOverride(m) {
    if ('TRUE' === process.env.AI_BACKGROUND_REMOVER_TEST_LIVE ||
        'TRUE' === process.env.AI_BACKGROUND_REMOVER_TEST_OVERRIDE) {
    ...
    m.AI_BACKGROUND_REMOVER_TEST_EXPLAIN = process.env.AI_BACKGROUND_REMOVER_TEST_EXPLAIN || m.AI_BACKGROUND_REMOVER_TEST_EXPLAIN;
    return m;
}
