...
class BackgroundRemovalEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set AIBACKGROUNDREMOVER_TEST_BACKGROUND_REMOVAL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def background_removal_basic_setup(extra)
  ...
  entid_env_raw = ENV["AIBACKGROUNDREMOVER_TEST_BACKGROUND_REMOVAL_ENTID"]
