...
#      offline in seeded test mode (AiBackgroundRemoverSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AiBackgroundRemover_sdk.rb")
  SDK_CLASS = "AiBackgroundRemoverSDK"
  ...
  SDK_BASE = "AiBackgroundRemover_sdk"
