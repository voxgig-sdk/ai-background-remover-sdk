# AiBackgroundRemover Ruby SDK Reference

Complete API reference for the AiBackgroundRemover Ruby SDK.
...
#### `AiBackgroundRemoverSDK.test(testopts = nil, sdkopts = nil)`
