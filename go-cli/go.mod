module github.com/voxgig-sdk/ai-background-remover-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/ai-background-remover-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/ai-background-remover-sdk/go => ../go
