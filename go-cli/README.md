...
AQL-driven CLI and REPL for the AiBackgroundRemover SDK. Positional arguments are
...
```sh
go build -o ai-background-remover-cli ./...
```
...
./ai-background-remover-cli list background_removal
./ai-background-remover-cli load 1 background_removal
./ai-background-remover-cli load '{id:1}' background_removal
