...
func registerSDKWords(r *eng.Registry, client *sdk.AiBackgroundRemoverSDK) {
...
func runOp(client *sdk.AiBackgroundRemoverSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
