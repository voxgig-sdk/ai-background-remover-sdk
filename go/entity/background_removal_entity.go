...
type BackgroundRemovalEntity struct {
	name    string
	client  *core.AiBackgroundRemoverSDK
...
func NewBackgroundRemovalEntity(client *core.AiBackgroundRemoverSDK, entopts map[string]any) *BackgroundRemovalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BackgroundRemovalEntity) GetName() string { return e.name }
...
func (e *BackgroundRemovalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BackgroundRemovalEntity) Deleted() bool {
	return e.deleted
}


func (e *BackgroundRemovalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBackgroundRemovalEntity(e.client, opts)
}

func (e *BackgroundRemovalEntity) Data(args ...any) any {
...
func (e *BackgroundRemovalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BackgroundRemoval; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BackgroundRemovalEntity) DataTyped(data ...BackgroundRemoval) BackgroundRemoval {
	if len(data) > 0 {
		return typedFrom[BackgroundRemoval](e.Data(asMap(data[0])))
	}
	return typedFrom[BackgroundRemoval](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BackgroundRemoval (all fields
// optional at the wire level).
func (e *BackgroundRemovalEntity) MatchTyped(match ...BackgroundRemoval) BackgroundRemoval {
	if len(match) > 0 {
		return typedFrom[BackgroundRemoval](e.Match(asMap(match[0])))
	}
	return typedFrom[BackgroundRemoval](e.Match())
}
...
func (e *BackgroundRemovalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BackgroundRemovalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BackgroundRemovalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BackgroundRemovalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BackgroundRemovalCreateData and returns an BackgroundRemoval. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BackgroundRemovalEntity) CreateTyped(reqdata BackgroundRemovalCreateData, ctrl map[string]any) (BackgroundRemoval, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BackgroundRemoval{}, err
	}
	return typedFrom[BackgroundRemoval](res), nil
}



func (e *BackgroundRemovalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BackgroundRemovalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BackgroundRemovalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
