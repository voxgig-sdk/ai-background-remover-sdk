...
type AiBackgroundRemoverSDK struct {
	Mode     string
...
func (sdk *AiBackgroundRemoverSDK) OptionsMap() map[string]any {
...
func (sdk *AiBackgroundRemoverSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AiBackgroundRemoverSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AiBackgroundRemoverSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AiBackgroundRemoverSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AiBackgroundRemoverSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AiBackgroundRemoverSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AiBackgroundRemoverSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AiBackgroundRemoverSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AiBackgroundRemoverSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AiBackgroundRemoverSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AiBackgroundRemoverSDK {
	...
	sdk := NewAiBackgroundRemoverSDK(sdkopts)
	sdk.Mode = "test"
